...
public class CriarTabela extends JFrame {
	...
	public CriarTabela(){
		...
		String sentencaSQL = "CREATE TABLE Filmes(Titulo VARCHAR(50), Ano VARCHAR(50), Classificacao VARCHAR(50), Classificacao2 VARCHAR(50), Classificacao3 VARCHAR(50), Classificacao4 VARCHAR(50));";
